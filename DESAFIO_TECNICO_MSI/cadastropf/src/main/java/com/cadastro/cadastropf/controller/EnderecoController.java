...
import com.cadastro.cadastropf.service.EnderecoService;
...
public class EnderecoController {
    ...
    @Operation(summary = "Cadastra novo Endereço", description = "Cadastra novo Endereço com IdPessoa da Pessoa")
    @PostMapping("/endereco/{pessoaId}")
    public ResponseEntity<Long> cadastrarEndereco(@Valid @RequestBody Endereco end,@PathVariable(value = "pessoaId") long id) {
